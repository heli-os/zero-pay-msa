...
public class TransferWithdrawRequest {
    ...
    public TransferWithdrawRequest(String fintechUserNum, BankCorp bank, String bankAccountId, long amount, String receivedAccountId, String receivedAccountDescription, String channelRequestId) {
    ...
    public String toString() {
        return "TransferWithdrawRequest{" +
